...
{
    changeBg("kon")
text="Россия погрузилась в хаос <a href='javascript://' onclick='part2()'>революции</a>. Партии открыто снаряжают вооруженные отряды, гуляющие по улицам. Власти не могут ничего поделать с ситуацией и судьба всей Империи завязалась на жизни одного студента, о котором и пойдет речь. Жизни одного из тех, кого называют 'бурной молодежью', они часто сами не знают на какой они стороне, но при этом уже вступают в самые различные революционные кружки и организации."
changetext(text)
cleardo()
...
text="Вы видите неписанную красавицу, скромно сидящую в уголке."
changetext(text)
...
{
    cleardo()
text="Краем глаза вы замечаете танцующего Великого Князя и княгиню."
changetext(text)
...
function dance()
{
text="Вы продолжаете кружиться по залу в танце, но нельзя же заниматься этим вечно."
changetext(text)
}
function part27()
{
cleardo()
text="Князь стоит в нескольких шагах от... Что же он будет делать!?"
changetext(text)
...
changeBg("panic")
cleardo()
text="С громким хлопком пуля вылетела из револьвера. Не ожидавший подобного Михаил был сражен, ноги его подкосились, лицо изобразило подобие великого ужаса, Княгиня закричала, в зале началась паника. И вот, несколько бравых офицеров Российской армии прямо в парадной форме несутся к нигилисту."
changetext(text)
...
{
cleardo()
text="Сквозь толпу Главный герой протискивается к выходу, когда один из офицеров достает парадную саблю и готовится его огреть."
changetext(text)
...
{
cleardo()
text="- Говоришь, что вокзал наполнен жандармами? Тогда остается один вариант, взорвать поезд уже после отправления, то есть на пути в Москву."
changetext(text)
